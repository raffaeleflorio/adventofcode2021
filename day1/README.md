...
To do this, _count the number of times a depth measurement increases_ from the previous measurement. (There is no
...
In this example, there are _7_ measurements that are larger than the previous measurement.
