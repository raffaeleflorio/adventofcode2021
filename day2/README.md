...
It seems like the submarine can take a series of instructions like `forward 1`, `down 2`, or `up 3`:
...
The instructions also mean something entirely different than you first thought:
...
Using this new interpretation of the instructions, calculate the horizontal position and depth you would have after
