...
public final class CO2ScrubberRating implements BinaryNumber {
   ...
   */
  public CO2ScrubberRating(final String... numbers) {
   ...
   * @param numbers The numbers
   */
  public CO2ScrubberRating(final List<BinaryNumber> numbers) {
    this(numbers, IndexedOneFrequencies::new);
  }

  CO2ScrubberRating(final List<BinaryNumber> numbers, final Function<List<BinaryNumber>, List<Long>> frequencyFn) {
